...
/* ════════════════════════════════════════════
   Fiches — Chooser Hub
   Two form types: Suivi (MAINTENANCE) & Individuel (REPAIR)
   ════════════════════════════════════════════ */
  ...
  return (
    <div className="flex-1 overflow-auto">
      <div className="max-w-lg mx-auto px-3 pt-4 pb-6 space-y-4">
        ...
        <Link
          href="/fiche/suivi"
          className="block bg-[#141414] rounded-xl border border-white/6 p-4 active:scale-[0.98] transition-all"
        >
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1 min-w-0">
              <h3 className="text-sm font-bold text-white">Fiche de Suivi</h3>
              <p className="text-[11px] text-gray-500 mt-0.5">Rapport d&apos;entretien (SERVICED)</p>
        ...
        >
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1 min-w-0">
              <h3 className="text-sm font-bold text-white">Fiche Individuel pour Frigo</h3>
              <p className="text-[11px] text-gray-500 mt-0.5">Rapport de réparation (REPAIRED)</p>
              <p className="text-[11px] text-gray-600 mt-1">
